...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        if block is BasicBlock:
            self.nChannels = [self.inplanes, int(64 * self.multiplier), int(128 * self.multiplier), int(256 * self.multiplier), int(512 * self.multiplier), int(512 * self.multiplier)]
        elif block is Bottleneck:
            self.nChannels = [self.inplanes, int(64 * self.multiplier)*4, int(128 * self.multiplier)*4, int(256 * self.multiplier)*4, int(512 * self.multiplier)*4, int(512 * self.multiplier)*4]
